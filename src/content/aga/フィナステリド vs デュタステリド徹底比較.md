...
- 発毛効果はデュタステリド優位（複数の論文データで一貫）
- 副作用の差は添付文書の数字ほど大きくない
- 妊活・半減期・肝機能・コストが選択の分かれ目になる
...
- 半減期が大幅に長くなるため、副作用が出た場合の影響が長引く可能性がある点を理解しておく
...
AGA治療では、フィナステリド・デュタステリドのような「DHT抑制薬」に加えて、**ミノキシジル**を併用するケースが多い。
